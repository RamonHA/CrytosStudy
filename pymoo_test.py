...
def main(symbols, algorithm_name):
    ...
    problem = TATunning(
        ...
        xl = [0, 5, 3, 2, -10, -10]*2 + [0, 4, 2, -10, -10]*8 + [0, 5, 2, 4, -10, -10],
        xu = [1, 50, 20, 8, 10, 10]*2 + [1, 50, 20, 10, 10]*8 + [1, 40, 20, 22, 10, 10],
    ...
    with open( f"results/metaheuristics/Slopes_{algorithm_name}_{gen}.json", "w" ) as fp:
        json.dump( data, fp )
